...
/// <summary>
/// Represents a GiroPay payment source within the PayPal SDK.
/// </summary>
[DataContract]
public class GiroPaySource
{
    /// <summary>
    /// Gets or sets the name associated with the GiroPay payment source.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets or sets the country code associated with the GiroPay payment source.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets or sets the experience context for configuring the GiroPay payment experience.
    /// </summary>
    /// <remarks>
