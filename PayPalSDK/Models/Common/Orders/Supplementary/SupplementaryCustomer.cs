...
/// <summary>
/// Represents supplementary customer information for a PayPal order.
/// </summary>
[DataContract]
public class SupplementaryCustomer
{
    /// <summary>
    /// Gets or sets the IP address of the customer.
    /// </summary>
    /// <remarks>
    /// The IP address can be either IPv4 or IPv6 format. 
    /// It is validated using a regular expression to ensure proper formatting.
    /// </remarks>
